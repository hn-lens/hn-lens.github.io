...
| R-15 | MEDIUM | open | SPEC-GAP | A red CI on main for ANY reason now skips the deploy with no notification. R-01 and R-14 removed two causes; the silent-skip amplifier itself remains. Needs a notification channel decision. | — |
